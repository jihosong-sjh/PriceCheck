...
export default function HomePage() {
  return (
    <div className="min-h-[calc(100vh-200px)] flex flex-col">
      {/* 히어로 섹션 */}
      <section className="flex-1 flex items-center justify-center bg-gradient-to-br from-primary-50 via-white to-blue-50">
        ...
        <div className="container-wide">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">시세 조회</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">가격 분석</h3>
              <p className="text-gray-600">
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">상태별 조정</h3>
              <p className="text-gray-600">
      ...
      <section className="py-16 bg-primary-600">
        <div className="container-narrow text-center">
          ...
          <Link href="/price-guide" className="btn bg-white text-primary-600 hover:bg-primary-50 btn-lg no-underline">
            무료로 가격 확인하기
          </Link>
        </div>
      </section>
